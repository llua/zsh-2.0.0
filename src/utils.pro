...
void freecmdnam DCLPROTO((void *a));
void freestr DCLPROTO((void *a));
void freeanode DCLPROTO((void *a));
void freepm DCLPROTO((void *a));
...
void spckword DCLPROTO((char **s,int cmd));
...
void *allocnode DCLPROTO((int type));
void *dupstruct DCLPROTO((void *a));
void freestruct DCLPROTO((void *a));
